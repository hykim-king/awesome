...
### 1-2. 프로젝트 개요
- **목표**
  1. 당일 핫이슈를 놓치지 않게: 카테고리별 AI 분류 및 추천
  2. 시사 상식 복습: 뉴스 기반 퀴즈 & 순위 제공
  3. 의견 교류: 주제별 소통 창구 제공
- **사용자 대상**: 디지털 환경에서 뉴스 소비에 익숙한 사용자
...
### 1-4. 프로젝트 선정 기준
- **실현 가능성**: 배운 기술 내에서 구현 가능  
- **창의성/시장성**: “나라도 쓰고 싶은” 뉴스 플랫폼  
- **학습 및 팀워크 성장**: AI 기능 접목 & 협력 중심
