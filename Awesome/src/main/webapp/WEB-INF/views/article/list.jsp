...
.page-article-list .main{ min-width:0; } /* 긴 제목 줄바꿈 안정화 */
...
@media (max-width:900px){
  .page-article-list .layout{ grid-template-columns:1fr; }
...
.news-title a{
  color:var(--blue); text-decoration:none; font-weight:700; font-size:18px; word-break:break-word;
}
...
.page-article-list #header .submenu-box{
  position:absolute !important; top:55px; left:0; right:0;
  height:var(--submenu-h);
  display:flex; align-items:center; justify-content:center;
  padding:0; background:transparent; border:0; z-index:1;
}
.page-article-list #header .submenu{
  display:flex !important; align-items:center; justify-content:center; gap:40px;
  list-style:none; margin:0; padding:0; white-space:nowrap;
}
.page-article-list #header .submenu a{
  display:block; padding:10px 2px; font-size:14px; line-height:1;
  color:#333; text-decoration:none; white-space:nowrap; word-break:keep-all;
}
.page-article-list #header .submenu a:hover{ color:#0a45ff; text-decoration:underline; text-underline-offset:3px; }

/* 파란 메뉴바 하단 라인 비노출(흰띠처럼 보일 수 있어) */
.page-article-list #header .menu-bar::after{ background:transparent; }
...
<c:if test="${empty sessionScope.userId and not empty sessionScope.loginUser}">
